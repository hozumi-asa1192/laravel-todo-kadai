                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <h5 class="card-title ms-1 mb-0">
                                            @if ($todo->done)
                                                <s class="d-block">{{ $todo->content }}</s>
                                                <s class="fs-6">{{ $todo->discription }}</s>
                                            @else
                                                {{ $todo->content }}
                                                <br>
                                                <div class="fs-6 mt-2">{{ $todo->discription }}</div>
                                            @endif
                                        </h5>                                        
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end text-center" aria-labelledby="dropdownTodoMenuLink">
                                                <li>
                                                    <form action="{{ route('goals.todos.update', [$goal, $todo]) }}" method="post">
                                                        ...
                                                        <input type="hidden" name="discription" value="{{ $todo->discription}}">
                                                        @if ($todo->done)  
                                    ...
                                    <!-- <h6 Class="card-subtitle ms-1 mb-2">{{ $todo->discription }}</h6>    -->
